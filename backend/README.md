...
## DB Schema
See [docs/DB_SCHEMA.md](docs/DB_SCHEMA.md) for the full schema documentation including field types, constraints, design decisions, and Cloud Storage path conventions.
